            ...
            <>
                  ...
                  <div className="flex flex-col font-poppins max-w-[593px] h-[435px] content-between justify-between ml-[30px]">
                    ...
                    <div>
                      <div>
                        <div className="flex">
                          <Book />
                          <h2 className="ml-[10px]">{data.block1.whatStudyTitle}</h2>
                        </div>
                      ...
                      <div className="mt-[30px]">
                        <div className="flex">
                          <Hat />
                          <h2 className="ml-[10px]">{data.block1.whatTeachTitle}</h2>
                        </div>
                    ...
                    <div className="flex flex-row justify-between text-fourteen">
                      <div className="flex">
                        <p className="font-gilroy text-twenty">{data.block1.price} BYN</p>
              ...
              <section className="flex justify-between items-center">
                <div className="flex mt-[70px] font-poppins">
                  <div className="max-w-[745px] max-h-[562px]">
                    <div className="flex flex-col justify-between max-w-[745px] h-[247px]">
                      <h2 className="text-twentyfive font-gilroy">{data.block2.subBlock21.title}</h2>
                    ...
                    <div className="flex flex-col justify-between max-w-[745px] h-[245px] mt-[70px]">
                      <h2 className="font-gilroy text-twentyfive">{data.block2.subBlock22.mainTitle}</h2>
                      <p className="mt-[6px]">{data.block2.subBlock22.subMainTitle}</p>
                      <div className="flex flex-row">
                        <div>
                          <h3 className="font-gilroy text-twenty">{data.block2.subBlock22.subTitle1}</h3>
                          <p className="mt-[12px] text-fourteen">{data.block2.subBlock22.paragraph1}</p>
                        </div>
                        <div>
                          <h3 className="font-gilroy text-twenty">{data.block2.subBlock22.subTitle2}</h3>
                ...
                <div className="max-w-[485px] h-[476px] p-9 flex flex-col justify-between font-poppins text-fourteen bg-local-gray-b rounded-2xl ">
                  <h2 className="font-gilroy text-twentyfive">{data.block2.subBlock23.title}</h2>
              ...
              <section className="flex items-center justify-between font-poppins text-fourteen mt-[70px]">
                <div className="flex flex-col justify-between h-[258px] max-w-[745px]">
                  <h2 className="font-gilroy text-twentyfive">{data.block3.subBlock31.title}</h2>
                ...
                <div className=" max-w-[488px] h-[188px] flex flex-col justify-between py-[26px] px-[63px] bg-local-gray-b rounded-2xl ">
                  <h3 className="font-gilroy text-twentyfive">{data.block3.subBlock32.mainTitle}</h3>
                  <p>{data.block3.subBlock32.paragraph1}</p>
                </div>
              </section>
